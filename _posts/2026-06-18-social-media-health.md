---
layout: post
title: "Social Media and Health: What the Science Actually Shows — And Why the UK Just Banned It for Under-16s"
subtitle: "The sleep disruption link is well-established. The mental health debate is more complex. Here is what the evidence actually supports."
tags: [mental health, sleep, adolescents, social media, screen time, evidence-based, digital health]
comments: true
description: "A biomedical scientist's breakdown of what the research shows about social media and human health — the well-documented harms, the contested claims, and what the UK's landmark ban is actually based on."
thumbnail-img: /assets/img/posts/social-media-health-hero.webp
---

<style>
.bio-btn { display:inline-block;background:linear-gradient(135deg,#2e7d5e,#52b788);color:#fff !important;text-decoration:none !important;border-radius:8px;font-weight:700;font-size:0.88rem;padding:0.55rem 1.3rem;margin:0.3rem 0.3rem 0.3rem 0;box-shadow:0 4px 14px rgba(46,125,94,0.3);transition:transform 0.2s ease,box-shadow 0.2s ease; }
.bio-btn:hover { transform:translateY(-2px) scale(1.03);box-shadow:0 6px 20px rgba(46,125,94,0.45);text-decoration:none !important; }
...
.bio-btn-secondary:hover { background:#2e7d5e;color:#fff !important; }
...
<figure class="post-figure">
  <img src="/assets/img/posts/social-media-health-hero.webp" alt="Teenager looking at phone screen in dark room before sleep, blue light illuminating face" class="post-img">
  <figcaption>The image is familiar: a teenager in a dark room, face lit by a phone screen long past the time they should be asleep. Of all the documented harms of social media, this one is the most mechanistically clear.</figcaption>
</figure>
...
<figure class="post-figure">
  <img src="/assets/img/posts/social-media-sleep.webp" alt="Glowing smartphone screen on a nightstand next to a sleeping teenager, representing sleep disruption from social media" class="post-img">
  <figcaption>Social media use at night operates through at least three distinct biological pathways to disrupt sleep. Of all the documented harms, this one has the strongest mechanistic support.</figcaption>
</figure>
...
**References:**
- Levenson JC, Shensa A, Sidani JE, Colditz JB, Primack BA. (2017). Social media use before bed and sleep disturbance among young adults in the United States: a nationally representative study. *Sleep*, 40(9), zsx113. [PubMed](https://pubmed.ncbi.nlm.nih.gov/28934521/){:target="_blank" rel="noopener"}
- Lund L, et al. (2021). Electronic media use and sleep in children and adolescents in western countries: a systematic review. *BMC Public Health*, 21, 1598. [PubMed](https://pubmed.ncbi.nlm.nih.gov/34479503/){:target="_blank" rel="noopener"}
...
**References:**
- Orben A, Przybylski AK, Blakemore SJ, Kievit RA. (2022). Windows of developmental sensitivity to social media. *Nature Communications*, 13, 1649. [PubMed](https://pubmed.ncbi.nlm.nih.gov/35347142/){:target="_blank" rel="noopener"}
...
**References:**
- Orben A, Przybylski AK. (2019). The association between adolescent well-being and digital technology use. *Nature Human Behaviour*, 3(2), 173-182. [PubMed](https://pubmed.ncbi.nlm.nih.gov/30944443/){:target="_blank" rel="noopener"}
- Alonzo R, Hussain J, Stranges S, Anderson KK. (2021). Interplay between social media use, sleep quality, and mental health in youth: a systematic review. *Sleep Medicine Reviews*, 56, 101414. [PubMed](https://pubmed.ncbi.nlm.nih.gov/33385767/){:target="_blank" rel="noopener"}
